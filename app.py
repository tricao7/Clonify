...
def main():
    ...
    st.write(
        "1. Upload a .wav file that you want to clone the voice of with the prompt: 'The North Wind and the Sun were disputing which was the stronger, when a traveler came along wrapped in a warm cloak.\
